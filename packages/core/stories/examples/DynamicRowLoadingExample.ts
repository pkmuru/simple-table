...
export const dynamicRowLoadingExampleDefaults = { height: "400px" };

export function renderDynamicRowLoadingExample(args?: Partial<UniversalVanillaArgs>): HTMLElement {
  const options = { ...defaultVanillaArgs, ...dynamicRowLoadingExampleDefaults, ...args };
