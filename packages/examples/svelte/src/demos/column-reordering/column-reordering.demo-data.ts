...
export const columnReorderingHeaders: SvelteHeaderObject[] = [
  ...
  { accessor: "department", disableReorder: true, label: "Department", width: "1fr", type: "string" },
];

export const columnReorderingData = [
...
export const columnReorderingConfig = {
